...
from apis.bitget_c.consts import GET
from apis.bitget_c import consts as c
from apis.bitget_c import utils 
...
class BitgetWsClient:
    ...
    def __init__(self, need_login=False, url=c.CONTRACT_WS_URL):
